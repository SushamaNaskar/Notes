...
# virtual computers (virtual: made to appear to exist by computer)
- A virtual computer is a computer that is created using software, not a physical machine you can touch.
- A powerful real computer in a data center can create many virtual computers inside it.
- So one big computer can act like many smaller computers.

📦 Example

You open your laptop and connect to a cloud machine.
...
Even though the actual computer is somewhere else.