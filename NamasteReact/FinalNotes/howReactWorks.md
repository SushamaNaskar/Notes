...
# rendering 
rendering means calling the fuction/component again, it tirggers the reconciliation cycle.
...
# Flow of React
1. Initial rendering - virtual Dom is created.
...
5. Commit phase => React updates the actual DOM
6. Browser paint => When the browser is rendering elements on the screen based on the styles and layout defined in the document.
